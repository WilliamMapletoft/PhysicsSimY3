...
namespace PhysicsEngine
{
	...
	void DynamicActor::CreateShape(const PxGeometry& geometry, PxReal density, PxU32 mIndex)
	{
		PxShape* shape = ((PxRigidDynamic*)actor)->createShape(geometry,*GetMaterial(mIndex));
